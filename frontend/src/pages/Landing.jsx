      ...
      <section className="content-section services" id="services">
        <div className="section-container">
          ...
          <p className="section-text">
            We offer a wide range of services to make your event planning
          ...
          <div className="value-grid">
            <div className="my-block">
              ...
              <p className="block-text">
                Track RSVPs, dietary needs, and seating in one place.
              </p>
            </div>
            <div className="my-block">
              ...
              <p className="block-text">
                Compare and book caterers, venues, and more.
              </p>
            </div>
            <div className="my-block">
              ...
              <p className="block-text">
                Design floorplans and schedules with drag-and-drop.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section-container">
          ...
          <div className="about-content">
            <p className="section-text highlight-first">
              At <strong>Event-ually Perfect</strong>, we believe every
              celebration should be as unique as the people it honors. Your
              events aren't just dates on a calendar—they're the milestones that
              define your story.
            </p>
            ...
            <div className="mission-statement">
              <p className="section-text">
                Because your wedding should taste like childhood memories.
                Because your gala should spark the same excitement as your first
                success. We don't just plan events—we design experiences that
                disappear into the background, leaving only the joy of
                connection.
              </p>
              <button
                className="hero-button"
